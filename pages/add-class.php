...
<head>
  ...
  <!-- CSS only -->
	...
	<link rel="stylesheet" href="../css/class-adding.css">
				...
				<div class="sidebar">
						<div class="sidebar-item" >
                            <a class="index" href="dash.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-app-indicator" viewBox="0 0 16 16">
                                ...
                                <div class="sidebar-item">
                                     <a class="index" href="dash-account.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="       currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
...
<section class="transition-fade whole">

  <form action = "php/includes/function.php" method = "post" >

      	<div class="name">
      	  <h5>Class Name</h5>
      		<input name="subname" placeholder="Introduction to Programming">
      	</div>

      	<div class="code">
      	<h5>Class Code</h5>
      			<input name="subcode" placeholder="ITP201">
      	</div>

      	<div class="section">
      	<h5>Section Code</h5>
      			<input name="sectcode" placeholder="CEIT-37-702A">
      	</div>
        ...
        <div class="addingbtn">
    	     <button name="submitaddclass" type="submit"> Add </button>
        </div>

        <div class="cancelingbtn">
            <a href="dash-manage.php"><button name="canceladdclass" type="button"> Cancel </button></a>
        </div>

        <div class="studlistbtn1">
        ...
        <table class="table text-white">
          ...
          <tbody>
              ...
              ?>
						...
						<div>
							<button id="addclass" type="button" style="margin-left:1350px ; margin-top:500px;">ADD</button>
						</div>
