...
<head>
  ...
  <!-- CSS only --> 
	...
	<body>
		...
		<div class="DATE" style="margin-left: 100px;">
			<h5>OCTOBER 1, 2022 | ITP111 | ATTENDANCE RESULT<h5>
    	...
    	<div class="col-md-12 text-center">
    			<div class="card text-white" style="height: 720px; margin-top: 50px; width: 1500px; margin-left: 90px;background-color: #194F90;position: relative;">
    				<div>
						...
						<div class="container-fluid">
							<a id="addclass" class="index" href="Add-class.php"><button type="button" class="btn btn-outline-primary" style="margin-left:1190px ; margin-top:500px;">ADD</button></a>&nbsp;
                       <a button type="button" class="btn btn-outline-warning" style="margin-left:1320px ; margin-top:-70px;">SAVE</button></a>
