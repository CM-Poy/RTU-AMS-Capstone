                          ...
                          <?php
                            ...
                            if($result->rowCount() > 0){
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)){
                                $fname_stud=$row["fullname_stud"];
                                $instemail_stud=$row["instemail_stud"];
                                $studno_stud=$row["studentsid_stud"];
                                $gfname_stud=$row["gfullname_stud"];
                                $gemail_stud=$row["gemail_stud"];
            
                                echo '

                                  <tr>
                                        <td>'.$fname_stud.'</td>
                                        <td>'.$instemail_stud.'</td>
                                        <td>'.$studno_stud.'</td>
                                        <td>'.$gfname_stud.'</td>
                                        <td>'.$gemail_stud.'</td> 
