                              ...
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)){
                                ...
                                echo '
                                  ...
                                  <tr>
                                        <td>'.$code_dept.'</td>
                                        <td>'.$name_dept.'</td>
                                        <td><a class="add" name="addDept" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                                        <a class="edit" name="editDept" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a class="delete" name="delDept" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
                              </tr>';
                              }
                            }
                        ?>
