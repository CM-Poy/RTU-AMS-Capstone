          ...
          <div class="table-responsive">
              <div class="table-wrapper">
                  <div class="table-title">
                      <div class="row">
                          <div class="col-sm-8"><h2>Section <b>Details</b></h2></div>
                          <div class="col-sm-4">
                        ...
                        <?php
                            ...
                            if($result->rowCount() > 0){
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)){
                                ...
                                $name_crs_sect=$row["name_crs_sect"];
                                $name_yearlvl_sect=$row["name_yearlvl_sect"];
                                ...
                                echo '
                                  ...
                                  <tr>
                                        <td>'.$code_sect.'</td>
                                        <td>'.$name_crs_sect.'</td>
                                        <td>'.$name_yearlvl_sect.'</td>
                                        <td><a class="add" name="addSect" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                                        <a class="edit" name="editSect" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a class="delete" name="delSect" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
                              </tr>';
                              }
                            }
                        ?>
