          ...
          <div class="table-responsive">
              <div class="table-wrapper">
                  <div class="table-title">
                      <div class="row">
                          <div class="col-sm-8"><h2>Teacher's <b> Details</b></h2></div>
                          <div class="col-sm-4">
                        ...
                        <?php
                            ...
                            if($result->rowCount() > 0){
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)){
                                ...
                                $fname_users=$row["fullname_users"];
                                $instemail_users=$row["instemail_users"];
                                $empno_users=$row["empno_users"];
                                $pass_users=$row["pass_users"];
                                $usertype_users=$row["usertype_users"];
                                ...
                                echo '
                                  ...
                                  <tr>
                                        ...
                                        <td><a class="add" name="addUsr" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
                                        <a class="edit" name="editUsr" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a class="delete" name="delUsr" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
                              </tr>';
                              }
                            }
                        ?>
        ...
        // Append table with add row form on add new button click
          ...
          var index = $("table tbody tr:last-child").index();
              var row = '<tr>' +
                  ...
                  '<td><input type="text" class="form-control" name="Honoriffic" id="Honoriffic"></td>' +
                  '<td><input type="text" class="form-control" name="Institutional Email" id="Institutional Email"></td>' +
                  '<td><input type="text" class="form-control" name="Employee Number" id="Employee Number"></td>' +
                  '<td><input type="text" class="form-control" name="Employee Number" id="Employee Number"></td>' +
