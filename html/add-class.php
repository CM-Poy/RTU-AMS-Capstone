<<<<<<< Updated upstream:html/add-class.php
<html>
...
<body>
	...
	<div class="day">
	 <h2>Day</h2>
		...
		<div>
			<button class="button1" name="create" type="submit"> Cancel </button>
			<button name="Cancel" type="submit"> Add </button><br><br>
			

			
			 	<a class="index" href="class list.html"><button class="button2" name="create" type="submit"> Student List </button>
			 </a>
		</div>
</body>	
</html>
...
<head>
  ...
  <tbody class="tablebody">
    <tr>
      <td>INTRODUCTION TO COMPUTING</th>
      <td>ITP-1111</td>
      <td>MONDAY</td>
      <td>7:30AM-9:00AM</td>
      <td><button type="button" class="btn btn-danger"><i class="far fa-trash-alt"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
<html>
>>>>>>> Stashed changes:html/add-class.html
