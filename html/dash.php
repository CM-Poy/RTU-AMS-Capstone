<<<<<<< Updated upstream:html/dash.php
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- CSS only --> 
	...
	<body>
		...
		<main>
				<div class="inner-containers center">
                <div class="inner-container-1">
                    <div class="card-1">
                        <div class="card-1-imgBx">
                            <img src="" alt="">
                        </div>
                        <h2 class="count">Subject01</h2>
                        <h4></h4>
                    </div>
                    <div class="card-1">
                        <div class="card-1-imgBx">
				...
				<div class="sidebar">
						<div class="sidebar-item" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-app-indicator" viewBox="0 0 16 16">
                                ...
                                <div class="sidebar-item">
                                     <a class="index" href="dash-calendar.html"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="       currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16">
                                    <path d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                                    <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 
                                     1h12a1 1 0 0 0 1-1V4H1z"/>
...
>>>>>>> Stashed changes:html/dash.html
