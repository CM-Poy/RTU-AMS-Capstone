            ...
            <div class="col-sm-4 my-auto">
                <div class="cardcolor text-white" style="border-radius: 1rem; height: 750px; width: 400px;">
                  <div class="card-body p-5">
                    ...
                    <?php
                    include 'php/includes/action.php';
                    $view = new signupErrorHandlers();
                    $view->errorHandlers();
                    ?>
                    ...
                    <div class="inputspace1">
                      ...
                      <div class="form-outline form-white mb-4">
                        ...
                        <input type="number" name="schoolid" id="typeEmailX" class="form-control form-control-lg" placeholder="Ex: 2028-104574" />

                      </div>
                      <div class="inputspace4">
                      <div class="form-outline form-white mb-4">
                        <label class="form-label" >CONTACT NO.</label>
                        <input type="number" name="cnumber" id="typeEmailX" class="form-control form-control-lg" max="11" min="11" />
                      ...
                      <div class="form-outline form-white mb-4">
                        ...
                        <input type="email" name="email" id="typeEmailX" class="form-control form-control-lg" placeholder="@gmail.com" />
